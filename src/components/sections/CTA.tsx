        ...
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <Reveal delay={0.15}>
            <p className="mt-10 max-w-2xl text-lg text-mist">
              ...
              конкурентов, не тяните. Лоты стартуют от ₽99, AI-брифинг занимает 3–5 минут,
              средний срок статики — около 4 часов, максимум сутки. Лендинги и Telegram-боты —
              3–5 рабочих дней.
            </p>
          </Reveal>
          <Reveal delay={0.25}>
          ...
          <Reveal delay={0.35}>
            <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-3">
              {[
                ...
                { k: "Срок", v: "~4ч статика · 3–5 д лендинг/бот", href: BRAND.funpay },
              ].map((c) => (
                <a
                  key={c.k}
                  href={c.href}
